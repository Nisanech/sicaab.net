...
namespace Sicaab.Web.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public ProveedorController(SicaabDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sicaabDbContext = _context.Proveedor.Include(p => p.IdCategoriaNavigation);
        ...
        {
            ViewData["IdCategoria"] = new SelectList(_context.CategoriaProveedor, "IdCategoria", "Categoria");
            return View();
        }
