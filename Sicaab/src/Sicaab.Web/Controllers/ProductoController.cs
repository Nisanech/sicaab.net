...
namespace Sicaab.Web.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ProductoController(SicaabDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sicaabDbContext = _context.Producto.Include(p => p.IdArteNavigation).Include(p => p.IdCategoriaNavigation);
        ...
        {
            ViewData["IdArte"] = new SelectList(_context.ArteProducto, "IdArte", "Alto");
            ViewData["IdCategoria"] = new SelectList(_context.CategoriaProducto, "IdCategoria", "Categoria");
            return View();
        }
